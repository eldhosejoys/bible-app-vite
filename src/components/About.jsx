        ...
        <div className="row justify-content-center ">
          <div className="col-lg-12 col-xxl-12 ">
            <div className="py-4">
              ...
              <ul>
                <li>45 :- <i>പുസ്തകം: റോമർക്ക് എഴുതിയ ലേഖനം</i></li>
                <li>6 :- <i>6-ാം അദ്ധ്യായം</i></li>
                <li>6-7 :- <i>6 മുതൽ 7 വരെയുള്ള വചനം</i></li>
              </ul>
              <p>ഇതു പോലെ, നിങ്ങൾക്ക് ഒറ്റ വചനം, ഒരു വചനം പരിധി, അല്ലെങ്കിൽ ഒരു മുഴുവൻ അദ്ധ്യായം നേരിട്ട് കാണാൻ കഴിയും.</p>
