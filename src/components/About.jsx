        ...
        <div className="row justify-content-center ">
          <div className="col-lg-12 col-xxl-12 ">
            <div className="py-4">
              ...
              <p>ഈ വെബ്‌സൈറ്റിൽ നൽകിയിരിക്കുന്ന മലയാളം പരിഭാഷ എടുത്തിരിക്കുന്നത് <a target="_blank" href="https://github.com/godlytalias/Bible-Database/tree/master/Malayalam">ഇവിടെ നിന്നാണ്</a>. അതിൽ നിന്ന് വായിച്ചപ്പോൾ കണ്ട മലയാളത്തിലെ അക്ഷരതെറ്റുകൾ മറ്റും തിരുത്തിയിട്ടാണ് ഇവിടെ കൊടുത്തിരിക്കുന്നത്. ഈ വെബ്സൈറ്റിൻറെ കോഡ് കിട്ടുന്നതിനായി <a target="_blank" href="https://github.com/eldhosejoys/bible-app">ഗിറ്റ്ഹബ് സന്ദർശിക്കുക</a>.</p>
